<html><head>
    ...
    <div class="row text-center">
      <h1 id="titolo">Promozioni</h1>
    </div>
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-6 thumbnail" style="padding-bottom:20">
            <img src="imgs\telefoni\iphone6.jpg" class="img-responsive" style="margin-top: 10px; margin-bottom: 10px; height: 46.20%">
            <h2>
              <p class="text-center">iPhone 23 S</p>
            </h2>
            <table style="width:100%" class="table table-bordered left-table">
              <tbody>
                <tr>
                  <th class="prices">16GB
                    <br>
                    <s>€ 729,00</s>
                    <p>
                      <b>€ 629,00*</b>
            ...
            <p class="text-center" style="font-size:9">*solo se ti abboni ad un servizio TIM a scelta per un anno</p>
            <div class="text-center">
              <a href="#" class="btn btn-primary linknonvalidi" role="button">Acquista subito</a>
            </div>
          </div>
          <div class="col-md-6 thumbnail">
            <img src="imgs\tablet\alcatelonetouchpixi3.PNG" id="immaginidispositivi" style="height:50%">
            <div class="caption text-center">
              <h3>Alcatel</h3>
              <h3>One Touch Pixi 3</h3>
              <p id="prezzo">9.99€ al mese*</p>
              <p style="font-size:9">*per soli 3 anni</p>
              <p>
                <a href="#" class="btn btn-primary linknonvalidi" role="button">Acquista subito</a>
              </p>
            </div>
          ...
          <div class="row container-fluid">
            <div class="navbar-header">
              ...
              <div class="navbar-brand" style="padding: 0; padding-top: 1; padding-left: 3px;">
                <p class="navbar-text">PROMOZIONI /</p>
              </div>
            </div>
          </div>
        </nav>
