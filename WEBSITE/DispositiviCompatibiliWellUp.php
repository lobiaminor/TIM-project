<html><head>
    ...
    <title>TIM | WellUp: dispositivi compatibili</title>
    ...
    <ul class="nav navbar-nav navbar-left">
     ...
     <ul class="hidden-xs nav navbar-nav navbar-right">   
      ...
      <li><a href="#" id="linknonvalidi"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"> Carrello</span></a></li> 
          ...
          <div class="container">
        <div class="row">
          <div class="col-md-8" onclick="goBack()">
            <a id="tornaindietro" style="text-align: center" class="btn btn-primary "><span class="glyphicon glyphicon-arrow-left"></span> Torna indietro</a>
            <h4>WellUp: dispositivi compatibili</h4>
          </div>
        </div>
      </div>
    </div>
...
<div class="hidden-md hidden-lg">
    ...
    <div class="thumbnail">
      <img src="imgs\telefoni\iphone6.jpg" id="immaginidispositivi">
      ...
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <div class="navbar-brand" style="padding: 0; padding-top: 1; padding-left: 3px;">
            <p class="navbar-text">SMART LIFE / SALUTE / WELLUP: DISPOSITIVI COMPATIBILI /</p>
          </div>
        </div>
      </div>
    </nav>
