...
<!--Barra superiore-->
  ...
  <div class="container-fluid">
    ...
    <div class="row" style="margin-top: 10; margin-left: 10%;">
      ...
      <div class="col-xs-12 col-sm-12 col-md-3 img-responsive" style="width: 500">
        <a class="thumbnail text-center img-responsive" href="Progetti.php">
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 img-responsive" style="width: 500">
        <a class="thumbnail text-center img-responsive" href="Testimonials.php">
    ...
    <div class="carousel slide" id="carousel-example-generic" data-ride="carousel" style="margin-left:5%; margin-right:5%">
      <div class="carousel-inner" role="listbox">
        <div class="carousel-inner" role="listbox">
            <?php
             $immagine = getImmagine('innovazione2');
              $mydiv = '<div class="item active">';
              $mydiv .= '<img style="width: 80%;" src="'.$immagine['path'].'" />';
              $mydiv .= '</div>';
              echo $mydiv;

             $immagine = getImmagine('innovazione3');
              $mydiv = '<div class="item">';
              $mydiv .= '<img style="width: 80%;" src="'.$immagine['path'].'" />';
              $mydiv .= '</div>';
              echo $mydiv;

             $immagine = getImmagine('innovazione4');
              $mydiv = '<div class="item">';
              $mydiv .= '<img style="width: 80%;" src="'.$immagine['path'].'" />';
              $mydiv .= '</div>';
              echo $mydiv;

              $immagine = getImmagine('innovazione5');
              $mydiv = '<div class="item">';
              $mydiv .= '<img style="width: 80%;" src="'.$immagine['path'].'" />';
              $mydiv .= '</div>';
              echo $mydiv;
      ...
      <div class="container-fluid">
        <div class="navbar-header" style="float: none">
          ...
          <div class="navbar-brand" style="padding: 0; padding-top: 1; padding-left: 3px;">
            <p class="navbar-text">CHI SIAMO / INNOVAZIONE /</p>
          </div>
        </div>
      </div>
    </nav>
