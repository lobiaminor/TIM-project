<html><head>
    ...
    <title>TIM | Casa e Famiglia</title>
      ...
      <li><a href="#" id="linknonvalidi">Il gruppo</a></li> 
        ...
        <div class="row" id="rigacentrata">
          <div class="col-md-4 hidden-sm hidden-xs text-right" id="rigacentrata">
            <a href="TV_entertainment.php" class="btn btn-primary" id="bottonetabella"><span class="glyphicon glyphicon-arrow-left"></span> TV &amp; Entertainment</a>
          </div>
          <div class="col-sm-10 hidden-lg hidden-md">
            <a href="TV_entertainment.php" class="btn btn-primary" id="bottoniprevnext"><span class="glyphicon glyphicon-arrow-left"></span></a>
            <a style="float:right;" href="Salute_e_benessere.php" class="btn btn-primary"  id="bottoniprevnext"><span class="glyphicon glyphicon-arrow-right"></span></a>
          </div>
          <div class="col-md-4">
              <a class="thumbnail">
                <img src="imgs\smartlife\casa e famiglia.PNG">
              </a>
              <div class="text-center">
                <a href="D-Link.php">D-Link Smart Home</a>
                <p></p>
                <a id="linknonvalidi">TIM Tag</a>
                <p></p>
                <a id="linknonvalidi">TIM Home connect</a>
                <p></p>
              </div>
              <hr>
              <div class="text-center">
                <a href="#">Richiedi nuovo servizio SmartLife: Casa e Famiglia</a>
                <p>
          ...
          <div class="col-md-4 hidden-sm hidden-xs text-left" id="rigacentrata">
            <a href="Salute_e_benessere.php" class="btn btn-primary"  id="bottonetabella">Salute e benessere <span class="glyphicon glyphicon-arrow-right"></span></a>
          </div>
        </div>
      ...
      <div class="row container-fluid">
        <div class="navbar-header">
          ...
          <div class="navbar-brand" style="padding: 0; padding-top: 1; padding-left: 3px;">
            <p class="navbar-text">SMARTLIFE / CASA E FAMIGLIA /</p>
          </div>
        </div>
      </div>
    </nav>
