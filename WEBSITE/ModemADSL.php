        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-center">
              <h1 id="titolo">Modem ADSL</h1>
            </div>
            <p>
              <br>
              <br>Il modem ADSL2+ Wi-Fi N - DA2210 permette il collegamento ad Internet
              fino a 20 Megabit.
              <br>
              <br>E' dotato di una porta Usb Master per collegare e condividere, nella tua
              rete, stampant, hard disk o chiavette.
              <br>Il modem è compatibile con tutto. Dopo il primo avvio, in base ai servizi
              sottoscriti, si configura in automatico per il corretto funzionamento.</p>
            <img src="imgs\in_evidenza\modem_adsl.png" class="img-responsive" style="padding-top: 100px;">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <div class="navbar-brand" style="padding: 0; padding-top: 1; padding-left: 3px;">
            <p class="navbar-text">IN EVIDENZA / MODEM ADSL / </p>
          </div>
        </div>
      </div>
    </nav>
