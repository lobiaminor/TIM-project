<html><head>
    ...
    <title>TIM | Assistenza Smart Life</title>
  ...
  <div>
      ...
      <div id="tabellaDropdown" class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title">
            <a data-toggle="collapse" href="#collapse1">TIM GAMES</a>
          </h4>
        </div>
          <div id="collapse1" class="panel-collapse collapse">
            <div class="panel-body"><a href="Scopri_timgames.php">
              Scopri TIM Games
            </a></div>
    ...
    <div class="panel-group" id="pannellicollassati">
      <div class="panel panel-default" id="tabellaDropdown">
        <div class="panel-heading">
          <h4 class="panel-title">
            <a data-toggle="collapse" href="#collapse2">TIM READING</a>
          </h4>
        </div>
    ...
    <div class="panel-group" id="pannellicollassati">
      <div class="panel panel-default" id="tabellaDropdown">
        <div class="panel-heading">
          <h4 class="panel-title">
            <a data-toggle="collapse" href="#collapse3">TIM MUSIC</a>
          </h4>
        </div>
    ...
    <div class="panel-group" id="pannellicollassati">
      <div class="panel panel-default" id="tabellaDropdown">
        <div class="panel-heading">
          <h4 class="panel-title">
            <a data-toggle="collapse" href="#collapse4">TIM VISION</a>
          </h4>
        </div>
...
<div class="row hidden-xs hidden-sm" >
  <div class="col-md-3 col-md-offset-1">
    ...
    <a class="thumbnail" href="AssistenzaSmartLife.php" id="currentPage">
    <img src="imgs\assistenza\smartlife.PNG" class="img-rounded">
    </a>
      ...
      <div class="row container-fluid">
        <div class="navbar-header">
          ...
          <div class="navbar-brand" style="padding: 0; padding-top: 1; padding-left: 3px;">
            <p class="navbar-text">ASSISTENZA / SMART LIFE /</p>
          </div>
        </div>
      </div>
    </nav>
