     ...
     <ul class="hidden-xs nav navbar-nav navbar-right">   
      ...
      <div class="row">
        <div class="col-lg-12 text-center">
          <h1>Assistenza</h1>
          <p class="lead">Le soluzioni online per gestire la tua linea e i servizi adsl</p>
        </div>
      </div>
    ...
    <div class="section">
      <div class="container" >
        <ul id="dispositivi" class="list-inline text-center" >
          <li>
            <a href="GestioneLineaEServizi.php">
            <img src="imgs\assistenza\gestionelineaeservizi.PNG" class="img-responsive" id="linksimg">
              </a>
          </li>
          <li>
            <a href="ControlloCostiEPagamenti.php">
            <img src="imgs\assistenza\controllocostiepagamenti.PNG" id="linksimg" class="img-responsive">
              </a>
          </li>
          <li>
            <a href="AssistenzaSmartLife.php">
            <img src="imgs\assistenza\smartlife.PNG" class="img-responsive" id="linksimg">
              </a>
          </li>
          <li>
            <a href="SupportoConfigurazione.php">
            <img src="imgs\assistenza\supportotecnicoeconfigurazione.PNG" class="img-responsive" id="linksimg">
              </a>
          </li>
        </ul>
      </div>
      ...
      <div class="row container-fluid">
        <div class="navbar-header">
          ...
          <div class="navbar-brand" style="padding: 0; padding-top: 1; padding-left: 3px;">
            <p class="navbar-text">ASSISTENZA /</p>
          </div>
        </div>
      </div>
    </nav>
