  ...
  <div class="container-fluid">
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
              <img src="imgs\telefoni\iphone6.jpg" class="img-responsive align-center dispositivoimg" style="margin-top: 10px; margin-bottom: 10px">
              <a href="IPhone.php" class="text-center"><p class="text-center">Torna al dispositivo</p></a>

          </div>

          <div class="col-md-8 hidden-xs hidden-sm">
              <h4 style="padding-left: 50px" id="titolo">IPhone6: servizi Smart Life disponibili</h4>
                <table style="margin-top:10px" class="table-borderless table-sl">
                  <tr>
                    <th><a href="#" class="linknonvalidi">Pagamenti</a></th>
                    <th><a href="Running.php" class="">Running</a></th>
                 </tr>
                <tr>
                    <th><a href="#" class="linknonvalidi">Trasporti</a></th>
                    <th><a href="WellUp.php" class="">WellUp</a></th>
                 </tr>
                 <tr>
                    <th><a href="#" class="linknonvalidi">Coupon</a></th>
                 </tr>
              </table>
            </div>

            <div class="col-md-8 hidden-md hidden-lg">
                <h4 class="text-center" id="titolo">Iphone6: servizi Smart Life disponibili</h4>
                    <a href="#" class="linknonvalidi"><p class="text-center"><strong>Pagamenti</strong></p></a>
                    <a href="Running.php" class=""><p class="text-center"><strong>Running</strong></a></p>
                    <a href="#" class="linknonvalidi"><p class="text-center"><strong>Trasporti</strong></p>
                    <a href="WellUp.php" class=""><p class="text-center"><strong>WellUp</strong></a></p>
                    <a href="#" class="linknonvalidi"><p class="text-center"><strong>Coupon</strong></a></p>
            </div>
      ...
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <div class="navbar-brand" style="padding: 0; padding-top: 1; padding-left: 3px;">
            <p class="navbar-text">DISPOSITIVI / SMARTPHONE E TELEFONI / IPHONE6 / SERVIZI SMART LIFE DISPONIBILI</p>
          </div>
        </div>
      </div>
    </nav>
