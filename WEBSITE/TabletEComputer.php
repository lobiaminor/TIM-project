<html><head>
    ...
    <title>TIM | Tablet e computer</title>
...
<div class="hidden-md hidden-lg">
    ...
    <div class="thumbnail">
      <img src="imgs\tablet\ipad5.jpg" id="immaginidispositivi">
      <div class="caption text-center">
        <h3>Apple</h3>
        <h3>iPad 5</h3>
        <p id="prezzo">379.70€</p>
        <p><a href="#" class="btn btn-primary" role="button">Vai al dispositivo</a></p>
      </div>
    </div>
  </div>
  ...
  <div class="col-md-6 col-md-offset-1">
    <div class="thumbnail">
      <img src="imgs\tablet\SamsungGalaxyTabA.jpg" id="immaginidispositivi">
      <div class="caption text-center">
        <h3>Samsung</h3>
        <h3>Galaxy Tab A</h3>
        <p id="prezzo">349.90€</p>
        <p><a href="GalaxyTabA.php" class="btn btn-primary" role="button">Vai al dispositivo</a></p>
      </div>
    </div>
  </div>
  ...
  <div class="col-md-6 col-md-offset-5">
    <div class="thumbnail">
      <img src="imgs\tablet\lgGPadF7.jpg" id="immaginidispositivi">
      <div class="caption text-center">
        <h3>Lg</h3>
        <h3>GPad F 7</h3>
        <p id="prezzo">319.90€</p>
  ...
  <div class="col-md-6 col-md-offset-5">
    <div class="thumbnail">
      <img src="imgs\tablet\alcatelonetouchpixi3.png" id="immaginidispositivi">
      <div class="caption text-center">
        <h3>Alcatel</h3>
        <h3>One Touch Pixi 3</h3>
        <p id="prezzo">299.90€</p>
        <p><a href="#" class="btn btn-primary linknonvalidi" role="button">Vai al dispositivo</a></p>
      </div>
    </div>
  </div>
...
<div class="row hidden-xs hidden-sm" >
  <div class="col-md-3 col-md-offset-1">
    <a class="thumbnail" href="SmartphoneETelefoni.php" id="altrilink">
       <img src="imgs\dispositivi\smartphone e telefoni.PNG" class="img-rounded">
    </a>
    <a class="thumbnail" href="TabletEComputer.php" id="currentPage">
      <img src="imgs\dispositivi\tablet e computer.PNG" class="img-rounded">
    </a>
      ...
      <div class="row container-fluid">
        <div class="navbar-header">
          ...
          <div class="navbar-brand" style="padding: 0; padding-top: 1; padding-left: 3px;">
            <p class="navbar-text">DISPOSITIVI / TABLET E COMPUTER /</p>
          </div>
        </div>
      </div>
    </nav>
