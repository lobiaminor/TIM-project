<html><head>
    ...
    <title>TIM | Scopri TIM games</title>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-center">
              <h1 id="titolo">Scopri TIMgames</h1>
            </div>
            <p>
              <br>
              <br>TIMgames è un servizio dedicato al gaming che consente a tutti i clienti
              di scaricare su tablet e smartphone i migliori giochi on demand e in abbonamento
              per il mondo mobile. Con TIMgames avrai a dsposizione una library di olre
              1500 giochi, aggiornata ogni settimana con nuovi titoli e giochi in offerta
              presenti nell'area promozioni dello store. TIMgames è accessibile sia da
              App (scaricabile da GooglePlay) che da browser su www.timgames.it .
              <br>L'utente piuò scegliere la modalità di acquisto preferita tra on-demand
              e abbonamento.&nbsp;</p>
            <img src="imgs\in_evidenza\tim_games.png" class="img-responsive center-block">
            <p>
              <br>
              <br>In particolare:
              <br>
              <br>- On demand: a partire da 0.49€, acquistando e scaricando un gioco sul
              proprio telefonino.
              <br>- In abbonamento: con I Love Games Promo, a soli 2€ a settimana si possono
              scaricare senza limiti tutti i giochi presenti su TIMgames.
              <br>&nbsp; Il primo mese è in proporzione a solo 1€ a settimana.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <div class="navbar-brand" style="padding: 0; padding-top: 1; padding-left: 3px;">
            <p class="navbar-text">IN EVIDENZA / SCOPRI TIM GAMES /</p>
          </div>
        </div>
      </div>
    </nav>
