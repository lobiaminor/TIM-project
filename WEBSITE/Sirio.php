  ...
  <div class="container-fluid">
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
              <img src="imgs\outlet\sirio.png" class="img-responsive align-center dispositivoimg" style="margin-top: 10px">
              <p id="prezzo" class="text-center align-center">29.90€</p>
              <a href="#" class="buyLink linknonvalidi"><p class="text-center align-center">Acquista subito</p></a>
          ...
          <div class="col-md-4">
                ...
                <table style="width:100%; margin-top:10px" class="table table-bordered left-table">
                 ...
                 <tr>
                    <th class="plainText">SIRIO è un telefono con filo dal design elegante.
                        E’ dotato di ampio display LCD con data e ora, vivavoce e liste delle chiamate.
                        I tasti grandi, la regolazione del volume della suoneria e la facilità d'uso lo rendono adatto ad ogni esigenza.
                        Tra le caratteritiche di SIRIO ci sono anche la possibilità di richiamare gli ultimi numeri selezionati, l’esclusione del microfono e l’accesso diretto alla rubrica.
                        Non necessita di batterie o alimentatori.</th>
                 </tr>
                  <tr>
                 ...
                 <tr>
                    <th class="plainText">
                    <ul>
                      <li>Visualizza il numero chiamante</li>
                      <li>Vivavoce</li>
                      <li>Ampia rubrica telefonica</li>
                      <li>Senza batterie e alimentatore</li>
                   </ul></th>
                 </tr>
              </table>
             ...
             <div class="col-sm-4">
              ...
              <table style="width:100%; margin-top:10px" class="table table-bordered left-table">
                  <tr>
                    <th>
                    <a href="Gestione_della_linea.php">Gestione della linea</a><br>
                    </th>
                  </tr>
              </table>
          </div>
      ...
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <div class="navbar-brand" style="padding: 0; padding-top: 1; padding-left: 3px;">
            <p class="navbar-text">DISPOSITIVI / OUTLET / SIRIO /</p>
          </div>
        </div>
      </div>
    </nav>
