<html><head>
    ...
    <title>TIM | TV &amp; Entertainment</title>
    ...
    <nav id="landmark" class="navbar navbar-inverse">
      ...
      <li><a href="#" id="linknonvalidi">Il gruppo</a></li> 
        ...
        <div class="row" id="rigacentrata">
          <div class="col-md-4 hidden-xs hidden-sm text-right" id="rigacentrata">
            <a href="Servizi_alla_persona.php" class="btn btn-primary" id="bottonetabella"><span class="glyphicon glyphicon-arrow-left"></span>  Servizi alla persona</a>
          </div>
          <div class="col-sm-10 hidden-lg hidden-md hidden-sm">
            <a href="Servizi_alla_persona.php" class="btn btn-primary" id="bottoniprevnext"><span class="glyphicon glyphicon-arrow-left"></span></a>
            <a style="float:right" href="Casa_e_famiglia.php" class="btn btn-primary"  id="bottoniprevnext"><span class="glyphicon glyphicon-arrow-right"></span></a>
          </div>
          <div class="col-md-4">
              <a class="thumbnail">
                <img src="imgs\smartlife\tv e entertainment.PNG">
              </a>
              <div class="text-center">
                <a id="linknonvalidi">TV</a>           
                <a id="linknonvalidi">TIM Music</a>
                <p></p>
                <p></p>
                <a href="Scopri_timgames.php">TIM Games</a>     
                <a id="linknonvalidi">Serie A TIM</a>
                <p></p>
              </div>
            <hr>
            <div class="text-center">
              <a href="#">Richiedi nuovo servizio SmartLife: TV &amp; Entertainment</a>
              <p>
          ...
          <div class="col-md-4 hidden-xs hidden-sm text-left" id="rigacentrata">
            <a href="Casa_e_famiglia.php" class="btn btn-primary"  id="bottonetabella">Casa e famiglia <span class="glyphicon glyphicon-arrow-right"></span></a>
          </div>
        </div>
      ...
      <div class="row container-fluid">
        <div class="navbar-header">
          ...
          <div class="navbar-brand" style="padding: 0; padding-top: 1; padding-left: 3px;">
            <p class="navbar-text">SMARTLIFE / TV &amp; ENTERTAINMENT /</p>
          </div>
        </div>
      </div>
    </nav>
