...
<!--Barra superiore-->
  ...
  <div class="container-fluid">
    <ul class="nav navbar-nav navbar-left">
      ...
      <li><a href="Il_Gruppo.php" >Il gruppo</a></li> 
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
              <img src="imgs\tablet\SamsungGalaxyTabA.jpg" class="img-responsive align-center dispositivoimg" style="margin-top: 10px">
              <p id="prezzo" class="test-center">349.90€</p>
              <a href="#" class="buylink linknonvalidi"><p class="text-center">Acquista subito</p></a>

          </div>

          <div class="col-md-4">
                <h4>Samsung Galaxy Tab A</h4>
                <table style="width:100%; margin-top:10px" class="table table-bordered left-table">
                 ...
                 <tr>
                    <th class="plainText">
                    Design sottile e moderno, stile essenziale e cornice metallizzata esaltano il nuovo formato 4:3, donando a Galaxy TAB A un look moderno e sofisticato 
                    e garantendo la massima maneggevolezza grazie ai 7,5 millimetri di spessore e solo 456 grammi di peso.
                    Progettato per essere il tablet più portatile della categoria, Galaxy TAB A non accetta compromessi, regalandoti uno schermo più ampio rispetto ad altri tablet. 
                    Un nuovo display, ideale per visualizzare in modo ottimale presentazioni, siti web, pubblicazioni, e-book, e-mail.</th>
                 </tr>
                  <tr>
                 ...
                 <tr>
                    <th class="plainText">
                    <ul>
                      <li>Sistema Operativo Android 5.0</li>
                      <li>Display 9.7” TFT</li>
                      <li>Processore Snapdragon™ 410 QuadCore 1.2 GHz</li>
                   </ul></th>
                 </tr>
              </table>
              <a href="#" class="linknonvalidi"><strong>Visualizza servizi Smart Life disponibili</strong></a>
            </div>
      ...
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <div class="navbar-brand" style="padding: 0; padding-top: 1; padding-left: 3px;">
            <p class="navbar-text">DISPOSITIVI / TABLET E COMPUTER / SAMSUNG GALAXY TAB A /</p>
          </div>
        </div>
      </div>
    </nav>
