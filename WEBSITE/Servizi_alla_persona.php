<html><head>
    ...
    <title>TIM | Servizi alla persona</title>
    ...
    <nav id="landmark" class="navbar navbar-inverse">
      ...
      <li><a href="#" id="linknonvalidi">Il gruppo</a></li> 
        ...
        <div class="row" id="rigacentrata">
          <div class="col-md-4 hidden-sm hidden-xs text-right" id="rigacentrata">
            <a href="Salute_e_benessere.php" class="btn btn-primary" id="bottonetabella"><span class="glyphicon glyphicon-arrow-left"></span> Salute e benessere</a>
          </div>
          <div class="col-sm-10 hidden-lg hidden-md">
            <a href="Salute_e_benessere.php" class="btn btn-primary" id="bottoniprevnext"><span class="glyphicon glyphicon-arrow-left"></span></a>
            <a style="float:right;" href="TV_entertainment.php" class="btn btn-primary"  id="bottoniprevnext"><span class="glyphicon glyphicon-arrow-right"></span></a>
          </div>
          <div class="col-md-4">
              <a class="thumbnail">
                <img src="imgs\smartlife\servizi alla persona.PNG">
              </a>
              <div class="text-center">
                <a id="linknonvalidi">Pagamenti</a>      
                <a id="linknonvalidi">Trasporti</a>
                <p></p>
                <p></p>
                <a id="linknonvalidi">Fidelity Card</a>      
                <a id="linknonvalidi">Coupon</a>
                <p></p>
              </div>
            <hr>
            <div class="text-center">
              <a href="#">Richiedi nuovo servizio SmartLife: Servizi alla persona</a>
              <p>
                <a href="SmartLife.php">↑ TORNA ALLE CATEGORIE ↑</a>
              </p>
            </div>
          </div>
          <div class="col-md-4 hidden-sm hidden-xs text-left" id="rigacentrata">
            <a href="TV_entertainment.php" class="btn btn-primary" id="bottonetabella">TV &amp; Entertainment <span class="glyphicon glyphicon-arrow-right"></span></a>
          </div>
        </div>
    ...
    <nav class="DocumentList  navbar navbar-default" id="navigationbarp">
      <div class="row container-fluid">
        <div class="navbar-header">
          <div class="navbar-brand hidden-xs hidden-sm" style="padding: 0; padding-top: 2;">
          ...
          <div class="navbar-brand" style="padding: 0; padding-top: 1; padding-left: 3px;">
            <p class="navbar-text">SMARTLIFE / SERVIZI ALLA PERSONA /</p>
          </div>
        </div>
      </div>
    </nav>
